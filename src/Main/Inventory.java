...
public class Inventory {
    ...
    public void addInventory(String Ingredient) throws InventoryException {
    	int amtIngredient = 0;
    	try {
    		amtIngredient = Integer.parseInt(Ingredient);
    	} catch (NumberFormatException e) {
    		throw new InventoryException("Units of ingredient must be a positive integer");
    	}
		if (amtIngredient >= 0) {
			Inventory.ingredient += amtIngredient;
		} else {
			throw new InventoryException("Units of ingredient must be a positive integer");
		}
    }

    public void quantiteIngredient() {
    	addInventory(String chocolate);
    	addInventory(String coffee);
    	addInventory(String milk);
    	addInventory(String sugar);
    }
